...
async def main():
    ...
    handler = AgptGlassesHandler(False, image_request_queue, image_data_queue, asyncio.get_running_loop(), audio_data_queue, DEFAULT_AUDIO_SAMPLE_RATE, WHISPER_SAMPLE_RATE)
    ...
    image_observer = ImageObserver("qwen3.5-vision", api_key=LLM_API_TOKEN, api_base=LLM_API_BASE, imager=aria_imager, save_images=True, transcription_prompt=TRANSCRIPTION_PROMPT, summary_prompt=SUMMARY_PROMPT, history_k=4)
